...
public enum SqlTypeName {
  POINT(PrecScale.NO_NO, false, Types.JAVA_OBJECT, SqlTypeFamily.GEO), 
  ...
  public static final List<SqlTypeName> ALL_TYPES =
      ImmutableList.of(
          ...
          INTERVAL_SECOND,
          FLOAT, MULTISET, DISTINCT, STRUCTURED, ROW, CURSOR, COLUMN_LIST, POINT);
  ...
  public static final List<SqlTypeName> GEO_TYPES =
	      ImmutableList.of(POINT);
  ...
  public Object getLimit(
    ...
    case POINT:  // Ja dodao
    	if (!sign) {
    	 ...
    	 Coordinate coords = new Coordinate(10000, 1000);
